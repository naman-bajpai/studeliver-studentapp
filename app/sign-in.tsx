  ...
  return (
    ...
    <SafeAreaView className='bg-white h-full font-okra' >
      ...
      <ScrollView contentContainerClassName='h-full flex flex-col justify-center items-center relative ' >
        ...
        <View className='z-10 bg-accent mx-5 w-[90%]  mt-28 rounded-3xl p-10 shadow shadow-black elevation-md'>
          ...
          <View className="mt-6">
            ...
            <TextInput
              ...
              className="font-okra border border-gray-300 p-4 rounded-3xl mb-4 focus:border-primary focus:outline-none "
            />
            {/* <Text className="text-lg font-semibold mb-2">University Email</Text> */}
            <TextInput
              placeholder="Enter your university email"
              keyboardType="email-address"
              className="font-okra border border-gray-300 p-4 rounded-3xl mb-6 focus:border-primary focus:outline-none"
            />
          </View>
